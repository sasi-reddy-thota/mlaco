...
d = d=np.genfromtxt('data.csv',delimiter=',')
...
print('route of all the ants at the end in a wire:')
print(rute_opt)
print()
print('best path for optimal length of a wire :',best_route)
print('cost of the best path in a wire ',int(dist_min_cost[0]) + d[int(best_route[-2])-1,0])
